"""
Django settings for holidaybooking project.
...
INSTALLED_APPS = [
    ...
    'debug_toolbar',
    # Add cross-origin resource sharing to enable frontend access to api endpoints
    'corsheaders',
]
...
WSGI_APPLICATION = 'holidaybooking.wsgi.application'
...
# Set customized user model as default model
...
# Set allowed CORS urls
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000',
    'http://127.0.0.1:3000'
]

# Set stripe configurations
